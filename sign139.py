...
# 格式 ydypCk = Authorization值#手机号#authToken的值   注意Authorization值需要添加Basic前缀
# 定时：一天两三次
import os
import random
import time
...
class YP:
    ...
    def sso(self):
        ...
        if 'success' in return_data:
            if return_data['success']:
                ...
                self.send_notification('移动云盘任务结果',return_data['message'])
        else:
            print("出现未知错误")
    ...
    def receive(self):
        ...
        if return_data['msg'] == 'success':
            ...
            msg = f'当前待领取:{receive_amount}云朵,当前云朵数量:{total_amount}云朵'
            self.send_notification('移动云盘任务结果',msg)
        else:
            print(return_data['msg'])

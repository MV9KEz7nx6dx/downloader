...
QUERY_URL=f"https://database.deta.sh/v1/{DETA_PROJECT_ID}/download/query"
DELETE_URL=f"https://database.deta.sh/v1/{DETA_PROJECT_ID}/download/items/{args.taskkey}"
UPDATE_URL=f"https://database.deta.sh/v1/{DETA_PROJECT_ID}/download/items/"
